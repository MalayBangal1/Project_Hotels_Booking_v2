...
router.post('/hotels/:id/checkout', isLoggedIn, async (req, res) => {
	try {
		...
		const session = await stripe.checkout.sessions.create({
			...
			mode: 'payment',
			success_url: `https://book-hotels-hpx8.onrender.com/hotels/${hotel._id}/checkout/success`,
			cancel_url: `https://book-hotels-hpx8.onrender.com/hotels/${hotel._id}/checkout/cancel`
		});
		const paymentInfo = {
			...req.body,
